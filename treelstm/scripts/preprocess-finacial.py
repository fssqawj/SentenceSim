...
if __name__ == '__main__':
    print('=' * 80)
    print('Preprocessing FINACIAL dataset')
    print('=' * 80)

    base_dir = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
    data_dir = os.path.join(base_dir, 'data')
    finacial_dir = os.path.join(data_dir, 'finacial')
    lib_dir = os.path.join(base_dir, 'lib')
    train_dir = os.path.join(finacial_dir, 'train')
    dev_dir = os.path.join(finacial_dir, 'dev')
    test_dir = os.path.join(finacial_dir, 'test')
    ...
    split(os.path.join(finacial_dir, 'test.txt'), test_dir)
    ...
    # get vocabulary
    build_vocab(
        glob.glob(os.path.join(finacial_dir, '*/*.toks')),
        os.path.join(finacial_dir, 'vocab.txt'))
    build_vocab(
        glob.glob(os.path.join(finacial_dir, '*/*.toks')),
        os.path.join(finacial_dir, 'vocab-cased.txt'),
        lowercase=False)
